...
if __name__ == '__main__':
    producer = KafkaProducer(bootstrap_servers='34.134.194.165:9092')  # use your VM's external IP Here!
    with open('C:\DE20201\DE2021\lab7\data\game\game_data_split1.csv') as f:
        lines = f.readlines()
